...
//- 역할: 엔티티 조작
//- 이름: 엔티티명+Repositroy
//- extends JpaRepository<엔티티명, PK자료형>
public interface ItemRepository extends JpaRepository<Item, Long> {
	...
	Item findByNameIs(String string);

	Item findByNameEquals(String string);

	List<Item> findByColor(String string);

	List<Item> findByQty(int qty);

	static Item findFirstByColor(String string) {
	...
	//List<Item> findByQtyIsNullAndPriceGreaterThanOrDescriptionIsNullAndPriceGreaterThan(int i);

	List<Item> findByQtyNotNull();
